...
pretrained_model_pth = '/home/developer/ros2_ws/src/autonomous_vehicles/models/test_run12/model_e22_rp156_82.zip' # set to None if init model from zero 
