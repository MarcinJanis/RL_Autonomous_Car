...
def generate_launch_description():
    ...
    training_script_path = "/home/developer/ros2_ws/src/autonomous_vehicles/autonomous_vehicles/training_SB3.py"
    ...
    gz_bridge = Node(
        ...
        arguments=[
            ...
            # '/world/mecanum_drive/set_pose@ros_gz_interfaces/srv/SetEntityPose'
            '/world/mecanum_drive/set_pose/blocking@ros_gz_interfaces/srv/SetEntityPose@gz.msgs.Pose'
